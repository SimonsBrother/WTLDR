...
def test_receives_email(email_manager: emailing.EmailManager):
    """ Tries to get a certain email, using get_email, that I sent to the account, which ensures emails can be retrieved by ID.
     This indirectly tests the Email static methods function correctly when given valid data. """
    expected_email = emailing.Email(email_id=3, sender="Caleb Hair <calebthair@outlook.com>", subject="Lab rat test subject",
                                    body="Lab rat lab rat lab rat", time_sent=datetime.fromisoformat("2024-07-22 14:54:42"), processed=False)
...
# TODO update for new testing email, and also maybe improve
...
if __name__ == "__main__":
    ...
    test_receives_email(email_manager_)
    print("Passed")
